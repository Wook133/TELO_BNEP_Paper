...
if __name__ == "__main__":
    ...
    parser.add_argument('--env_name', type=str, help='The name of the Environment.', default="AntPyBulletEnv-v0")
    ...
    parser.add_argument('--initial_mu', type=float, help='Initial Mu starting point', default=-0.06275149512800082)

    parser.add_argument('--initial_sigma', type=float, help='Initial Sigma starting point', default=0.25)
