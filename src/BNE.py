...
def main(env_name, shared_directory, num_processors, num_evaluations, population_size, max_num_episodes, initial_sigma,
    ...
    reset_schedule = [5000, 15000, 25000, 30000, 50000, 75000, 100000, 300000, 600000, 9000000, 20000000, 40000000, 80000000]#, 9000000]
    reset_schedule = [5000, 15000, 25000, 30000, 50000, 75000, 100000, 300000, 600000, 4000000]#, 9000000]
    ...
    for i in range(settings['snn_settings'].bne_cycles):
        ...
        while j < reset_schedule[schedule_counter]:
            if (j == 0) and (middle_planning_fitness is not None) and (middle_solutions is not None) and (i == 9):
                middle_cmaes = CMAES(num_params=settings['actor_settings'].num_parameters,
                                     sigma_init=settings['actor_settings'].initial_sigma,
            ...
            cur_max_timestep_outer, cur_max_reward_outer, string_out = utils.calculate_maximum_timestep_count_1(
                ...
                threshold_A=0.90, threshold_B=0.75, threshold_C=0.50,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--shared_directory', type=str,
                        ...
                        default="D:/University/2020/BNE_November/Test")
    ...
    parser.add_argument('--num_processors', type=int, help='Number of processors to use.', default=3)
    ...
    parser.add_argument('--initial_sigma', type=float, help='Initial Sigma starting point', default=0.01)
    ...
    parser.add_argument('--bne_cycles', type=int, help='Maximum Number of Episodes to use', default=13)
